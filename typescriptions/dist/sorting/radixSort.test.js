...
const radixSort_1 = __importStar(require("./radixSort"));
describe('findDigit fn', () => {
    ...
    test('findDigit works with positive octal numbers', () => {
        const getOctalDigit = radixSort_1.findDigit(8);
        const num = 0o3503;
